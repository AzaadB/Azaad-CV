    ...
    <div>
      <>
        ...
        <div>
          ...
          <p className={styles.text}>
            If you want to see some of my projects click the projects page it
            will take you to my Github.
          </p>
          <p className={styles.text}>
            If you want to contact me click the contact page my email should be
            there.
          </p>
        </div>
      </>
